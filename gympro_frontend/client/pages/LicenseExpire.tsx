...
export default function LicenseExpire() {
    ...
    if (loading) {
        return (
            <div className="h-screen w-full overflow-hidden bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 flex">
                <LicenseSidebar activeView="expire" onNavigate={() => { }} />
                            ...
                            <div className="max-w-7xl mx-auto px-6 py-4">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center space-x-3">
                                        <div className="h-10 w-10 bg-gradient-to-br from-orange-500 to-red-600 rounded-lg flex items-center justify-center shadow-lg">
                                            <AlertTriangle className="h-6 w-6 text-white" />
                                        </div>
                                        <div>
                                            <h1 className="text-2xl font-bold text-gray-800">License Expiration</h1>
                                            <p className="text-sm text-gray-600">Monitor expiring licenses and renewals</p>
                                        </div>
                                    </div>
                                    <div className="text-right">
                                        <p className="text-sm font-medium text-gray-700">Admin Portal</p>
                                        <p className="text-xs text-gray-500">{format(new Date(), 'EEEE, MMMM dd, yyyy')}</p>
                                    </div>
                                </div>
                            </div>
                        </header>
